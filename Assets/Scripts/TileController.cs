...
public class TileController : MonoBehaviour
{
    ...
    private void OnMouseDown()
    {
        ...
        else
        {
            ...
            //jika sudah memilih tile dan pindah ke tile lain
            else
            {
                //Apakah ini object di sebelahnya
                ...
                //Jika bukan object disebelahnya
                else
                {
                    previousSelected.Deselect();
                    Select();
    ...
    public IEnumerator MoveTilePosition(Vector2 targetPosition, System.Action onCompleted)
    {
        ...
        //menjalankan animasi pada frame selanjutnya supaya tidak error
    ...
    private List<TileController> GetOneLineMatch(Vector2[] paths)
    {
        ...
        // Tile dikatakan match bila terdapat 3 atau lebih(termasuk tile yang digerakkan) pada satu garis
    ...
    public List<TileController> GetAllMatches()
    {
        ...
        //Match yang diperoleh dapat berupa garis vertikal atau horizontal
        ...
        // Jika terdapat match tambahkan tile yang dipilih ke dalam match tersebut
