...
public class BoardManager : MonoBehaviour
{
    ...
    //Untuk mengatur ukuran board melalui inspector
    [Header("Board")]
    public Vector2Int size;
    public Vector2 offsetTile;
    public Vector2 offsetBoard;

    //Menambah jenis tile pada inspector
    [Header("Tile")]
    ...
    private void CreateBoard(Vector2 tileSize)
    {
        ...
        for (int x = 0; x < size.x; x++)
        {
            for (int y = 0; y < size.y; y++)
            {
                ...
                //mencari tile dari berdasarkan nomor 0 sampai maksimal yang dimasukkan
    ...
    //Menempatkan tile pada posisi yang berbeda agar yang sama tidak saling berjejer
    ...
    private void ProcessMatches()
    {
        ...
        //berhenti ketika tidak ada yang cocok
    ...
    public List<TileController> GetAllMatches()
    {
        ...
        for (int x = 0; x < size.x; x++)
        {
            for (int y = 0; y < size.y; y++)
            {
                ...
                // pindah ke tile selanjutnya jika tidak cocok
                ...
                {
                    //tambah yang belum ada sama sekali
    ...
    private Dictionary<TileController, int> GetAllDrop()
    {
        ...
        for (int x = 0; x < size.x; x++)
        {
            for (int y = 0; y < size.y; y++)
            {
                ...
                {
                    //Memproses semua tile yang ada di atas tile yang telah hancur
                    for (int i = y + 1; i < size.y; i++)
                    {
                        ...
                        //Jika tile berada pada drop list, tambah peluang drop-nya
                        if (droppingTiles.ContainsKey(tiles[x, i]))
                        {
                            droppingTiles[tiles[x, i]]++;
                        }
                        //jika tile tidak berada pada drop list, tambah drop-nya menjadi 1
                        else
                        {
    ...
    private IEnumerator RepositionTiles(System.Action onCompleted)
    {
        ...
        for (int x = 0; x < size.x; x++)
        {
            for (int y = 0; y < size.y; y++)
            {
                ...
                //Lewati jika sudah berada pada posisi
